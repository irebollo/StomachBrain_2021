...
LOS_all = {'2','1','3b','3a','4','6d','6mp','6v','FEF','6ma','SFL','SCEF','24dd','24dv','23d','23c','p32pr','p24pr','55b','5mv','5m','5L'}
...
print ('-dpdf', '-painters', '/media/irebollo/storage/projects/Navigastric/scripts/plots&figures/OverlapSpiderSMCING')
...
print ('-dpdf', '-painters', '/media/irebollo/storage/projects/Navigastric/scripts/plots&figures/ESSpiderSMCING')
