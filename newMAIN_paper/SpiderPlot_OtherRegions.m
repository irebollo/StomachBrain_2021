...
LOS_all = {'11l','a9-46v','p10p','9-46d','a10p','10pp','s6-8','8BL','10d','10r','10v','6r','IFJa','IFSp','p9-46v','44','STSvp','TE1m','TE1p','STSva','TE1a'}
...
print ('-dpdf', '-painters', '/media/irebollo/storage/projects/Navigastric/scripts/plots&figures/OverlapSpiderOther')
...
print ('-dpdf', '-painters', '/media/irebollo/storage/projects/Navigastric/scripts/plots&figures/ESSpiderOther')
