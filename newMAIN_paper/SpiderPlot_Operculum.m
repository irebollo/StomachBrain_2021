...
LOS_all = {'PFcm','OP4','OP1','OP2-3','43','FOP1','FOP2','FOP3','FOP4','PoI1','PoI2','MI','Ig','52','RI','A1','PBelt','LBelt','MBelt','A4','A5','TA2','STSdp','STSda'}
...
print ('-dpdf', '-painters', '/media/irebollo/storage/projects/Navigastric/scripts/plots&figures/OverlapSpiderOperculum')
...
print ('-dpdf', '-painters', '/media/irebollo/storage/projects/Navigastric/scripts/plots&figures/ESSpiderOperculum')
