...
modelName = 'model101_BASIC_gender_FWD_BMI_Freq_Day_Group'
...
matlabbatch{1}.spm.stats.factorial_design.multi_cov.files = {[global_path2root_folder(),'\scripts\demographics\covariates\model101_covariates.txt']};
