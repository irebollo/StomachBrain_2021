...
modelName = 'HRV_LFonly'
models_dir =  'J:\navigastric\ClusterResults\demographics\models\'
...
subjectCounter = 0
for iS=1:length(heartData)
    
    if heartData(iS)==true
        subjectCounter = subjectCounter+1
    
    if subjectCounter<=length(subjectsNavigastric)
        subj_idx = subjectsNavigastric(subjectCounter)
    else
        subj_idx = subjectsPhysiens(subjectCounter-length(subjectsNavigastric))
    end
    filename = [root4csimages,filesep,'s3_csi_',sprintf('%.2d',iS),'_subj_idx_',num2str(subj_idx),'.nii']
...
matlabbatch{1}.spm.stats.factorial_design.multi_cov.files = {'J:\navigastric\scripts\Heart\heart_demos_new_LF.txt'};
...
matlabbatch{1}.spm.stats.factorial_design.masking.em = {'J:\navigastric\scripts\STOMACH_BRAIN\files\SPM_mask_THRESHOLDED_physiens.img,1'};
...
% matlabbatch{3}.spm.stats.con.consess{1}.tcon.name = 'inter';
% matlabbatch{3}.spm.stats.con.consess{1}.tcon.weights = 1;
% matlabbatch{3}.spm.stats.con.consess{1}.tcon.sessrep = 'none';
% matlabbatch{3}.spm.stats.con.consess{2}.tcon.name = 'NOTUSED';
% matlabbatch{3}.spm.stats.con.consess{2}.tcon.weights = [0 1];
% matlabbatch{3}.spm.stats.con.consess{2}.tcon.sessrep = 'none';
% matlabbatch{3}.spm.stats.con.consess{3}.tcon.name = 'Female+';
% matlabbatch{3}.spm.stats.con.consess{3}.tcon.weights = [0 1];
% matlabbatch{3}.spm.stats.con.consess{3}.tcon.sessrep = 'none';
% matlabbatch{3}.spm.stats.con.consess{4}.tcon.name = ' malee+';
% matlabbatch{3}.spm.stats.con.consess{4}.tcon.weights = [0 -1];
% matlabbatch{3}.spm.stats.con.consess{4}.tcon.sessrep = 'none';
% matlabbatch{3}.spm.stats.con.consess{5}.tcon.name = 'Stai+';
% matlabbatch{3}.spm.stats.con.consess{5}.tcon.weights = [0 0 -1];
% matlabbatch{3}.spm.stats.con.consess{5}.tcon.sessrep = 'none';
% 
% matlabbatch{3}.spm.stats.con.consess{6}.tcon.name = 'BMI+';
% matlabbatch{3}.spm.stats.con.consess{6}.tcon.weights = [0 0 0 1];
% matlabbatch{3}.spm.stats.con.consess{6}.tcon.sessrep = 'none';
% matlabbatch{3}.spm.stats.con.consess{7}.tcon.name = 'BMI -';
% matlabbatch{3}.spm.stats.con.consess{7}.tcon.weights = [0 0 0 -1];
% matlabbatch{3}.spm.stats.con.consess{7}.tcon.sessrep = 'none';
% matlabbatch{3}.spm.stats.con.consess{8}.tcon.name = 'Group +';
% matlabbatch{3}.spm.stats.con.consess{8}.tcon.weights = [0 0 0 0 1];
% matlabbatch{3}.spm.stats.con.consess{8}.tcon.sessrep = 'none';
% matlabbatch{3}.spm.stats.con.consess{9}.tcon.name = 'Group -';
% matlabbatch{3}.spm.stats.con.consess{9}.tcon.weights = [0 0 0 0 -1];
% matlabbatch{3}.spm.stats.con.consess{9}.tcon.sessrep = 'none';
% matlabbatch{3}.spm.stats.con.consess{10}.tcon.name = 'Stai+';
% matlabbatch{3}.spm.stats.con.consess{10}.tcon.weights = [0 0 1];
% matlabbatch{3}.spm.stats.con.consess{10}.tcon.sessrep = 'none';


matlabbatch{3}.spm.stats.con.consess{1}.tcon.name = 'LF+';
matlabbatch{3}.spm.stats.con.consess{1}.tcon.weights = [0 0 0 0 0 0 0 1];
matlabbatch{3}.spm.stats.con.consess{1}.tcon.sessrep = 'none';
matlabbatch{3}.spm.stats.con.consess{2}.tcon.name = 'LF-';
