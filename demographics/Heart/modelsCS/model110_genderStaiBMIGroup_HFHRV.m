...
outliers_hf = [true true true true true true true true false true true true true true true true true true true true true true true true true true true true true true true true true true true true true true true true false true true true true true true true true true true true]
subjectImages_temp(outliers)=[]
subjectImages_temp(~outliers_hf)=[]
...
matlabbatch{1}.spm.stats.factorial_design.multi_cov.files = {[global_path2root_folder(),'\scripts\Heart\heart_demos_new_HF.txt']};
...
matlabbatch{3}.spm.stats.con.consess{14}.tcon.name = 'HF+';
...
matlabbatch{3}.spm.stats.con.consess{15}.tcon.name = 'HF-';
