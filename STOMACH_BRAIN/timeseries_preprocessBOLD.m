...
filename_bold_output = global_filename(subj_idx,cfgMain,'BOLD_filtered_fullbandFilename');

plotDir = strcat (global_path2subject(subj_idx,cfgMain.sample),'PreprocessingLog',filesep);
plotFilename = strcat(plotDir,'S_',sprintf('%.2d',subj_idx),'_',cfgMain.task,'_preprocessBOLD');
