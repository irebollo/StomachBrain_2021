...
% Timeseries
filename_csfSignal_FB = global_filename(subj_idx,cfgMain,'filename_csf_Signal_FB'); % FB fullband
% SAVE Residuals i.e. the CSF regressed BOLD timeseries in which further
% analysisis will be made
filename_csfr_Residuals_FB = global_filename(subj_idx,cfgMain,'filename_csfr_Residuals_FB');
% Save Betas wcsfR x subject
filename_csfrBetas_FB = global_filename(subj_idx,cfgMain,'filename_csfr_Betas_FB');
...
gray_mask_filename = strcat(global_path2root_folder,filesep,'scripts',filesep,'STOMACH_BRAIN',filesep,'files',filesep','gray_mask.hdr');
...
filename_bold = global_filename(subj_idx,cfgMain,'BOLD_filtered_fullbandFilename'); % Load BOLD timeseries
load(filename_bold)
